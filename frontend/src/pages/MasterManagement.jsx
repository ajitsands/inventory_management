  ...
  const handleCustomerSubmit = async (e) => {
    ...
    try {
      ...
      const payload = editingId
        ...
        : { name: cName, code: cCode || `CUST-${Math.floor(1000 + Math.random() * 9000)}`, phone: cPhone, email: cEmail, address: cAddress };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Add, Edit, Deactivate or Delete organization master entities with automated transaction-protection rules</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <form onSubmit={handleLocationSubmit} className="bg-white dark:bg-slate-900 glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 shadow-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Location Code *</label>
                <input
                  type="text"
                  required
                  disabled={!!editingId}
        ...
        <div className="space-y-6">
          <form onSubmit={handleLocationSubmit} className="bg-white dark:bg-slate-900 glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 shadow-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Clinic Code *</label>
                <input
                  type="text"
                  required
                  disabled={!!editingId}
        ...
        <div className="space-y-6">
          <form onSubmit={handleCustomerSubmit} className="bg-white dark:bg-slate-900 glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 shadow-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Customer Code</label>
                <input
                  type="text"
                  disabled={!!editingId}
                  value={cCode}
